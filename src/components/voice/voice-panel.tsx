...
export function VoicePanel({
  ...
  // Keep VoiceRoom alive even when panel is closed (user stays connected)
  // The panel UI slides in/out, but the VoiceRoom component stays mounted
  const shouldRender = isOpen || !!activeRoom;

  return (
    <>
      {/* Hidden VoiceRoom that stays mounted when panel is closed but user is in a room */}
      {!isOpen && activeRoom && (
