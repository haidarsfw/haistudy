const en: Record<string, string> = {
  ...
  "payments.login_email_google_desc": "Must be Gmail — this is the one you pick when signing in with Google.",
  "payments.login_email_password_desc": "Any email works — this is the one you type when signing in.",
