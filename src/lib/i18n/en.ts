const en: Record<string, string> = {
  ...
  "pricing.diamond_details": "All VIP perks, an animated name glow across the app, the Diamond badge, and direct support for haistudy. Max 2 devices.",
  ...
  "payments.share_ack_desc": "Share the haistudy link with friends (LE86: 2 friends outside class → Rp 20,000). Upload proof in the payment step.",
