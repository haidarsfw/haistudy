const en: Record<string, string> = {
  ...
  "onboarding.ai_desc": "The AI button sits in the center of the bottom dock (mobile) or bottom-right (desktop). Ask anything about your course materials — the AI answers from the content in this platform.",
  ...
  "payments.success_policy": "The admin will follow up within 1×12 hours. If there's no response within 1×12 hours, you're entitled to a partial refund + login access.",
