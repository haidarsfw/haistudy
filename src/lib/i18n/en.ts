const en: Record<string, string> = {
  ...
  "payments.share_ack_desc": "You'll share haistudy via an Instagram Story using the template we provide. Post from your main Instagram account (your real one — not a secondary) and tag our official account @haidarsfw. Have your Story screenshot ready to upload in the payment step.",
  "payments.share_le86_note": "LE86 class only: you must share with 2 people outside your class for the Rp 20,000 price. Upload 2 Story proofs in the payment step.",
  ...
  "payments.err_proof_share2": "Second proof is required for LE86",
