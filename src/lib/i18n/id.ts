const id: Record<string, string> = {
  ...
  "pricing.diamond_details": "Semua perks VIP, efek nama glow di seluruh app, badge Diamond, dan dukungan langsung untuk haistudy. Max 2 device.",
  ...
  "payments.share_ack_desc": "Share link haistudy ke teman (LE86: 2 teman di luar kelas → Rp 20.000). Bukti share diunggah di langkah pembayaran.",
