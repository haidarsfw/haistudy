...
export const APP_DESCRIPTION = "Platform Belajar UTS BINUS B29";
...
export const PRESENCE_HEARTBEAT_VISIBLE_MS = 300_000; // 5 minutes
export const PRESENCE_HEARTBEAT_HIDDEN_MS = 1_800_000; // 30 minutes
