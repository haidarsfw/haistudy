// Greeting tips + fun facts for scope s1-uts-bm. Own module so the scope is
// fully isolated (no cross-scope import). Content is universal UTS study advice.

export const TIPS: readonly string[] = [
  "Buat peta konsep antar-sesi untuk melihat hubungan materi secara keseluruhan - UTS menguji pemahaman menyeluruh.",
  "Prioritaskan materi yang paling sering muncul di kisi-kisi UTS dan latihan soal semester ini.",
  "Gunakan teknik elaborative interrogation: tanya 'mengapa' dan 'bagaimana' untuk setiap konsep kunci.",
  "Latih menjawab soal essay dengan timer - kemampuan menulis cepat dan terstruktur sangat penting di UTS.",
  "Buat cheat sheet satu halaman per mata kuliah - proses pembuatannya sendiri meningkatkan pemahaman.",
  "Review kesalahan kuis dan latihanmu - pola kesalahan cenderung berulang saat ujian.",
  ...
  "Fokus pada pemahaman 'big picture' sebelum mendalami detail - UTS sering menguji koneksi antar materi.",
  ...
  "Perhatikan pola soal dari latihan - dosen sering menggunakan format yang konsisten.",
  ...
  "Tidur minimal 7 jam di malam sebelum UTS - kurang tidur secara signifikan menurunkan kemampuan berpikir.",
