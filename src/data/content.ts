...
export const content: Record<string, SubjectContent> = {
  ...
  biseko: {
    ...
    kisiKisi: [
      { topic: "Analisa STEEPLE", items: ["Analisa STEEPLE"] },
      { topic: "Faktor yang Memengaruhi Permintaan dan Penawaran", items: ["Faktor yang memengaruhi permintaan dan penawaran"] },
