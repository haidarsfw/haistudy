...
export const content: Record<string, SubjectContent> = {
  ...
  biseko: {
    ...
    kisiKisi: [
      { topic: "Analisa STEEPLE", items: [
        "Memahami kerangka analisis STEEPLE (Social, Technological, Economic, Environmental, Political, Legal, Ethical).",
        "Mampu mengidentifikasi dan menganalisis faktor-faktor eksternal yang memengaruhi bisnis menggunakan STEEPLE.",
        "Menerapkan analisis STEEPLE pada studi kasus bisnis.",
      ] },
      { topic: "Faktor yang Memengaruhi Permintaan dan Penawaran", items: [
        "Memahami hukum permintaan (law of demand) dan hukum penawaran (law of supply).",
        "Mengidentifikasi faktor-faktor yang memengaruhi permintaan: harga, pendapatan, harga barang terkait (substitusi & komplementer), selera, ekspektasi.",
        "Mengidentifikasi faktor-faktor yang memengaruhi penawaran: biaya produksi, teknologi, harga input, kebijakan pemerintah, ekspektasi.",
        "Menganalisis pergeseran kurva permintaan dan penawaran serta dampaknya terhadap keseimbangan pasar.",
      ] },
      { topic: "Hitungan Revenue dan Profit", items: [
        "Menghitung Total Revenue (TR), Average Revenue (AR), dan Marginal Revenue (MR).",
        "Menghitung Total Cost (TC), Average Cost (AC), dan Marginal Cost (MC).",
        "Menghitung profit: Profit = TR - TC.",
        "Memahami kondisi profit maximisation: MR = MC.",
        "Membedakan normal profit, supernormal profit, dan loss.",
      ] },
      { topic: "Oligopoly & Game Theory", items: [
        "Memahami karakteristik pasar oligopoli: sedikit penjual, saling ketergantungan, hambatan masuk tinggi.",
        "Menganalisis perilaku strategis menggunakan game theory (teori permainan).",
        "Memahami konsep Nash Equilibrium dan Prisoner's Dilemma dalam konteks bisnis.",
        "Menganalisis keputusan kolusi vs kompetisi antar perusahaan oligopoli.",
      ] },
    ],
